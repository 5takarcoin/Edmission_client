...
export default function Page({params}: {params: {uni: string}}) {
  ...
  const reviews: Reviews[] = [
    ...
    },
    {
      ...
      date: "July 20, 2024",
      stars: 3,
      review: "BUET is still the top university of Bangladesh only because of the admission exam. If there were no exams, I wouldn’t even consunier BUET a top 10 university in Bangladesh."
    }
  ]
  ...
  return (
    <div className="space-y-8">
      <div className="">
        {data[0]?.name && <UniHero uni={data[0]}/>}
        {/* <UniNav /> */}
        <UniCatCards />
